...
-- First, we'll create a user in the auth.users table if it doesn't exist
-- This is typically done through Supabase auth, but for demo purposes we'll ensure an admin user exists
